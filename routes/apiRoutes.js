...
var mlab =
  ...
  ":" +
  password +
  "@ds137687.mlab.com:37687/mongoscraperkg";
...
router.get("/api/scrape", function(req, res) {
  ...
  axios
    .get("https://www.theguardian.com/environment/great-barrier-reef")
...
router.delete("/articles", function(req, res) {
  db.Article.remove({ saved: false }).then(function(dbArticle) {
    if (dbArticle) {
